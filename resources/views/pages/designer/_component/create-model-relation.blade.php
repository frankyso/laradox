<div class="modal fade" tabindex="-1" role="dialog" id="createRelationModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Add Relationship to model @{{temporary.relation.tableName}}</h4>
            </div>
...
public function @{{temporary.relation.function}}(){
    $this->@{{temporary.relation.relationType}}('@{{schema.namespace}}\@{{relationForeignModelName}}','@{{temporary.relation.foreignKey}}');
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" v-on:click="createRelationshipSubmit">Make Relation</button>
            </div>
        </div>
    </div>
</div>